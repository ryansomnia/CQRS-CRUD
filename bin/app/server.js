...
function AppServer() {
  ...
  this.server.post('/api/book/v1',jwtAuth.verifyToken, bookHandler.postDataBook);
  this.server.get('/api/book/v1',jwtAuth.verifyToken, bookHandler.getDataBook);
  this.server.del('/api/book/v1/:id',jwtAuth.verifyToken, bookHandler.deleteDataBook);
  this.server.put('/api/book/v1/:id',jwtAuth.verifyToken, bookHandler.putDataBook);
  this.server.get('/api/book/v1/:id',jwtAuth.verifyToken, bookHandler.getByIdBook);
  // this.server.get('/api/book/v1/:title',basicAuth.isAuthenticated, bookHandler.getByTitleBook);
